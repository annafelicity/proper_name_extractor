...
#(this can pose a problem if you only want people's names, 
#but you can add corporate stopwords to a stopword list)
...
#I have tried to make the pattern names descriptive of the patterns, 
#i.e. "initialdot_last_suffixdot" corresponds to names like "J. Mascis Jr.", 
#"first_initial_apostrophiclast" to "S. O'Connor", 
#"first_initialdot_last" to "Mary J. Blige", 
#"first_last" to "Kim Gordon", etc. etc.
...
def remove_stopwords(string):
    stopwords = ['Musician','Rock','Band'] 
    #this will eliminate "Kid Rock" from being extracted, but I think that's a good thing...
